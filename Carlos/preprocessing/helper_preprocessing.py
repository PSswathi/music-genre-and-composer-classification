...
def folder_initializer(output_dir, extracted_features_dir, train_test_val_dir, chunked_output_dir, composers):
    #https://stackoverflow.com/questions/185936/how-to-delete-the-contents-of-a-folder
    #Initialize folders a priori

    output_directories = [output_dir, extracted_features_dir, train_test_val_dir, chunked_output_dir]
